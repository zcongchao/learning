...
public class Inventory extends JFrame
{
   ...
   public void createUserInterface()
   {
	  ...
	  cartonsJLabel.setText( "Cartons per shipment:" );//设置文本属性名称为"Cartons per shipment:"
	  cartonsJLabel.setBounds( 16, 16, 130, 21 );//设置cartonsJLabel的范围属性，位置为16,16，宽度和高度分别为130,20
      contentPane.add( cartonsJLabel );

      // set up itemsJLabel
      itemsJLabel = new JLabel();
	  itemsJLabel.setText( "Items per carton:" );
	  itemsJLabel.setBounds( 16, 48, 104, 21 );//与上一个标签保持距离左边界具有相同的距离（16像素）
	  ...
	  cartonsJTextField.setHorizontalAlignment( JTextField.RIGHT );//向右对齐
      ...
      totalResultJTextField.setHorizontalAlignment( 
         JTextField.RIGHT );
	  totalResultJTextField.setEditable( false );//使输出为不可编辑

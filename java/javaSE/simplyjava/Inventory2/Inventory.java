...
public class Inventory extends JFrame//extends继承类JFrame
{
   ...
   private void calculateJButtonActionPerformed( ActionEvent event ) //calculateJButton+ActionPerformed事件处理命名规则
   {
